...
public class LobbyPreset extends BoardPreset{
    public static final String
            PLAYINGTITLE = ChatColor.BLUE + "" + ChatColor.BOLD + "Playing",
            RANKTITLE = ChatColor.BLUE + "" + ChatColor.BOLD + "Rank",
            TOKENSTITLE = ChatColor.BLUE + "" + ChatColor.BOLD + "Tokens",
            SITE = "thebubblenetwork",
            PLAYERNEED = "Players needed",
    ...
    public LobbyPreset(){
        super("Lobby",
                ...
                new BoardModuleBuilder("Spacer4", 1)
                        .withRandomDisplay()
                        .build(),
                new BoardModuleBuilder("address", 0)
                        .withDisplay(SITE)
                        .build()
        );
    }
