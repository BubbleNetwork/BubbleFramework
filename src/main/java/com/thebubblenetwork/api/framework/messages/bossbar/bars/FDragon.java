...
public class FDragon {
    ...
    static {
        try {
            ...
            setLocation = getMCClass("EntityEnderDragon").getMethod("setLocation", double.class, double.class, double
    ...
    public static Object getEnderDragon(Player p) throws IllegalAccessException, IllegalArgumentException,
    ...
    public static void setBossBartext(Player p, String text) {
        ...
        try {
            ...
            setLocation.invoke(nms_dragon, getPlayerLoc(p).getX(), getPlayerLoc(p).getY() + 800, getPlayerLoc(p).getZ
                    (), 0F, 0F);
