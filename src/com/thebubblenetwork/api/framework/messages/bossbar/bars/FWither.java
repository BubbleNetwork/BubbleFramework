...
public class FWither {
    ...
    static {
        try {
            ...
            packetPlayOutSpawnEntityLiving = getMCClass("PacketPlayOutSpawnEntityLiving").getConstructor(getMCClass
                                                                                                                 ("EntityLiving"));
            entityEntityWither = getMCClass("EntityWither").getConstructor(getMCClass("World"));


            setLocation = getMCClass("EntityWither").getMethod("setLocation", double.class, double.class, double
    ...
    public static Object getWither(Player p) throws IllegalAccessException, IllegalArgumentException,
    ...
    public static Object getWither2(Player p) throws IllegalAccessException, IllegalArgumentException,
            InvocationTargetException, InstantiationException {
    ...
    public static void setBossBartext(Player p, String text) {
        ...
        try {
            ...
            setLocation.invoke(nms_wither, getPlayerLoc(p).getX() + xr, getPlayerLoc(p).getY() - 3, getPlayerLoc(p)
                    .getZ() + xr2, 0F, 0F);
    ...
    private static void changeWatcher(Object nms_entity, String text) throws IllegalAccessException,
    ...
    public static Location getPlayerLoc(Player p) {
        ...
        String dir = getCardinalDirection(p);
        if (dir.equals("N")) {
            loc.add(0, 0, -50);
        }
