...
public class Messages {
    ...
    public static void sendTitleAndSubtitle(Player p, String title, String subtitle, TitleTiming timing) {
        try {
            TitleMessanger.sendTitle(p, ProtocolInjector.PacketTitle.Action.TITLE, title);
            TitleMessanger.sendTitle(p, ProtocolInjector.PacketTitle.Action.SUBTITLE, subtitle);
            TitleMessanger.sendTitle(p, ProtocolInjector.PacketTitle.Action.TIMES, timing.getIn(), timing.getShow(),
                                     timing.getOut());
